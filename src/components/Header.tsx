    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-hh-black/90 backdrop-blur-sm">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-5 sm:px-6">
        <Link to={routes.home} className="group min-w-0">
          <Logo text="hnrhr.com" className="block truncate text-xl transition group-hover:text-hh-red sm:text-2xl" />
        </Link>
        ...
        <button
          type="button"
          className="inline-flex h-10 w-10 items-center justify-center border border-hh-red/55 text-white transition hover:bg-hh-red hover:text-white md:hidden"
          aria-expanded={open}
